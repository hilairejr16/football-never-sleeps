...
const WC_QF_PREDICTIONS: Prediction[] = [
  {
    id: 'qf1', match: { id: 3001, status: 'SCHEDULED',
      ...
      homeScore: null, awayScore: null, date: new Date('2026-07-10T21:00:00Z').toISOString(),
    ...
    confidence: 71, generatedAt: new Date().toISOString(),
  },
  {
    ...
    predictedScore: { home: 1, away: 1 }, btts: true, over25Goals: false,
    keyFactor: "Mbappé vs the English backline — whoever wins that battle likely wins the tie",
    confidence: 64, generatedAt: new Date().toISOString(),
  },
  {
    id: 'qf3', match: { id: 3003, status: 'SCHEDULED',
      ...
      homeScore: null, awayScore: null, date: new Date('2026-07-11T17:00:00Z').toISOString(),
      league: { id: 1, name: 'FIFA World Cup', shortName: 'WC', logo: '', country: 'World', season: 2026, type: 'Cup' } },
    homeWinPct: 45, drawPct: 22, awayWinPct: 33,
    predictedScore: { home: 2, away: 1 }, btts: true, over25Goals: true,
    keyFactor: "The South American Super Clásico on the biggest stage — Brazil's pace vs Argentina's organisation",
    confidence: 58, generatedAt: new Date().toISOString(),
  },
  {
    id: 'qf4', match: { id: 3004, status: 'SCHEDULED',
      ...
      homeScore: null, awayScore: null, date: new Date('2026-07-12T21:00:00Z').toISOString(),
      league: { id: 1, name: 'FIFA World Cup', shortName: 'WC', logo: '', country: 'World', season: 2026, type: 'Cup' } },
    homeWinPct: 52, drawPct: 22, awayWinPct: 26,
    predictedScore: { home: 2, away: 0 }, btts: false, over25Goals: false,
    keyFactor: "Portugal's quality advantage is significant but USA's home crowd factor is historic",
    confidence: 67, generatedAt: new Date().toISOString(),
  },
];
