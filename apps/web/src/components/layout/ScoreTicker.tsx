...
const MOCK_LIVE: Match[] = [
  {
    id: 101, status: 'FT',
    homeTeam: { id: 10, name: 'Morocco',     shortName: 'MAR', logo: '', country: 'Morocco' },
    awayTeam: { id: 11, name: 'Canada',      shortName: 'CAN', logo: '', country: 'Canada' },
    homeScore: 3, awayScore: 0,
    date: new Date('2026-07-04T19:00:00Z').toISOString(),
    league: WC_LEAGUE,
  },
  {
    id: 102, status: 'FT',
    homeTeam: { id: 12, name: 'France',      shortName: 'FRA', logo: '', country: 'France' },
    awayTeam: { id: 13, name: 'Paraguay',    shortName: 'PAR', logo: '', country: 'Paraguay' },
  ...
  },
  {
    ...
    awayTeam: { id: 15, name: 'Brazil',      shortName: 'BRA', logo: '', country: 'Brazil' },
    homeScore: 2, awayScore: 0,
    date: new Date('2026-07-05T19:00:00Z').toISOString(),
    league: WC_LEAGUE,
  },
  {
    id: 104, status: 'FT',
    homeTeam: { id: 16, name: 'England',     shortName: 'ENG', logo: '', country: 'England' },
    awayTeam: { id: 17, name: 'Mexico',      shortName: 'MEX', logo: '', country: 'Mexico' },
  ...
  {
    id: 105, status: 'FT',
    homeTeam: { id: 18, name: 'Spain',       shortName: 'ESP', logo: '', country: 'Spain' },
    awayTeam: { id: 19, name: 'Portugal',    shortName: 'POR', logo: '', country: 'Portugal' },
    homeScore: 1, awayScore: 0,
  ...
  {
    id: 106, status: 'FT',
    homeTeam: { id: 20, name: 'Belgium',     shortName: 'BEL', logo: '', country: 'Belgium' },
    awayTeam: { id: 21, name: 'USA',         shortName: 'USA', logo: '', country: 'USA' },
  ...
  {
    id: 107, status: 'FT',
    homeTeam: { id: 22, name: 'Argentina',   shortName: 'ARG', logo: '', country: 'Argentina' },
    awayTeam: { id: 23, name: 'Egypt',       shortName: 'EGY', logo: '', country: 'Egypt' },
    homeScore: 3, awayScore: 2,
  ...
  {
    id: 108, status: 'PEN',
    homeTeam: { id: 24, name: 'Switzerland', shortName: 'SUI', logo: '', country: 'Switzerland' },
    awayTeam: { id: 25, name: 'Colombia',    shortName: 'COL', logo: '', country: 'Colombia' },
